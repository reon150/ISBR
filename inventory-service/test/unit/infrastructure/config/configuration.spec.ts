...
describe('Configuration', () => {
  ...
  it('should return default configuration when no env vars are set', () => {
    ...
    expect(config.cache.ttl.inventory).toBe(300);
  });
  ...
  it('should use environment variables when provided', () => {
    ...
    expect(config.cache.ttl.inventory).toBe(600);
  });
  ...
  it('should parse numeric values correctly', () => {
    ...
    expect(typeof config.cache.ttl.inventory).toBe('number');
    expect(config.cache.ttl.inventory).toBe(900);
  ...
  it('should have correct structure for all configuration sections', () => {
    ...
    expect(config.cache.ttl).toHaveProperty('inventory');
